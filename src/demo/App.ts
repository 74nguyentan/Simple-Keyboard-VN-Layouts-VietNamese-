 ...
 */
import layout from "../lib/layouts/vietnamese";
...
class App {
  ...
  onKeyPress = (button) => {
    ...
    if (button === "{lock}" || button === "{shift}")
      this.handletButton("shift");

    if (button === "{â}") this.handletButton("aa");
  };
}
